<?php
/**
 * TL_ROOT/system/modules/gallery/languages/fa/tl_member.php 
 * 
...
$GLOBALS['TL_LANG']['tl_member']['description']['0'] = "توضیح";
$GLOBALS['TL_LANG']['tl_member']['detail_legend'] = "جزئیات بیشتر";
